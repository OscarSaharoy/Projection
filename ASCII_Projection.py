...
class Cube(object):
    ...
    def __init__(self):
        ...
        self.vbuffer     = [[' ' for _ in xrange(self.w)] for _ in xrange(self.h)] # 2d list of characters to print on screen
    ...
    def display(self):
        ...
        self.vbuffer = [[' ' for _ in xrange(self.w)] for _ in xrange(self.h)] # clears vbuffer
